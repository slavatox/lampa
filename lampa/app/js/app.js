...
config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/Новости', {templateUrl: 'partials/Novos.html', controller: 'MyCtrl9'});
  ...
  $routeProvider.when('/Главная', {templateUrl: 'partials/Glavnaya.html', controller: 'MyCtrl13'});
    $routeProvider.when('/Фотогалерея', {templateUrl: 'partials/Foto.html', controller: 'MyCtrl14'});
